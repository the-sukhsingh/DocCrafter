        ...
        <>
            <footer className="bg-base-300 text-base-content">
                <div className="mx-auto">
                    ...
                    <footer className="footer sm:footer-horizontal sm:w-full bg-base-200 text-base-content p-10">
                        <aside>
                            <div>
                                <span className="footer-title text-2xl mb-6">ProjectForge</span>
                    ...
                    <div className="footer footer-center p-4 border-t border-base-content/10 text-base-content/70">
                        <div>
                            <p>© 2025 ProjectForge - All rights reserved</p>
                        </div>
                    </div>
